...
def fetch_data(ticker, period):
    try:
        ...
        st.write(f"Fetch data: close shape={close.shape}, volume shape={volume.shape}, dates shape={dates.shape}, close dtype={close.dtype}")
...
ticker = st.text_input("Ticker (f.eks. DNB.OL, AAPL)", "DNB.OL")
